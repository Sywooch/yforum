 ...
 */
class m160517_072923_create_post extends Migration
{
    /**
     * @inheritdoc
     */
...
//        文章分类
        ...
        $this->createTable($tableName, [
            'id'=>Schema::TYPE_PK,
            'name'=>Schema::TYPE_STRING."(255) Default NULL COMMENT '名称'",
            'type'=>Schema::TYPE_STRING."(32) Default NULL COMMENT '类型'",
            'description'=>Schema::TYPE_STRING." Default NULL COMMENT '描述'",
            'count'=>Schema::TYPE_INTEGER." UNSIGNED NOT NULL DEFAULT '0' COMMENT '内容个数'",
            'order'=>Schema::TYPE_INTEGER." UNSIGNED NOT NULL DEFAULT '0' COMMENT '项目排序'",
            'create_at'=>Schema::TYPE_INTEGER." UNSIGNED NOT NULL DEFAULT '0' COMMENT '创建在时间'",
            'update_at'=>Schema::TYPE_INTEGER." UNSIGNED NOT NULL DEFAULT '0' COMMENT '更新时间'"
        ],$this->tableOptions);
    ...
    {
        echo "m160517_072923_create_post cannot be reverted.\n";
